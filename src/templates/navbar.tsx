...
const Navbar = () => {
  return (
    // navbar z index 50
    <nav className="p-3 rounded-none bg-gray-100 bg-opacity-20 mx-auto w-full fixed top-0 z-50 ">
      <div className="container flex flex-wrap items-center justify-between mx-auto">
        <a href="#" className="flex items-center">
          ...
          <span
            ...
            className="self-center text-xl font-semibold whitespace-nowrap text-white uppercase tracking-wide"
          >
            MY <span class="text-blue-600 dark:text-blue-500">JOURNEY</span>
          </span>
        </a>
        <button
